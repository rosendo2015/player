...
## mobile first
## Versão para Desktop, notebook, tablet

![preview](./.github/preview.jpg)

> Projeto Bora Codar feito para cumprir desafio de player de música 
construído para praticar Desenvolvimento front end da Rocketseat :rocket:.
